...
/**
 * 加班流程测试，包含单人审批，候选人审批，多人审批(顺序)，任务监听器(创建时、指定审批人时、任务完成时)
 * 流程监听器--在任务中设置的，(流程启动、流程结束)，相对于任务的启动和结束而言
 * */
public class TestAddBill {
    ...
    public void startProcess(){
        ...
        String processDeId="addBill:1:4";
        //设置审批人的流程变量
    ...
    public void complete(){
        ...
        taskService.setAssignee(taskId,"林八");
